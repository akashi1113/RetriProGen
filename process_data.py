...
processed_path = '/data/crossdocked_pocket10_vqstp_processed.lmdb'
name2id_path = '/data/crossdocked_pocket10_vqstp_processed_name2id.pt'
db = lmdb.open(
    processed_path,
...
num_skipped = 0
df = pd.read_csv('/utils/dock_scores.csv')
with db.begin(write=True, buffers=True) as txn:
    for i, (pocket_fn, ligand_fn, _, rmsd_str) in enumerate(index):
        ...
        try:
            ...
            ligand_dict = parse_sdf_file(config, os.path.join(args.raw_data, ligand_fn))
