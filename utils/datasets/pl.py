...
class PocketLigandPairDataset(Dataset):
    ...
    def __init__(self, config, raw_path, transform=None):
        ...
        self.name2id_path = os.path.join(os.path.dirname(self.raw_path),
                                         os.path.basename(self.raw_path) + '_name2id_2.pt')
    ...
    def _process(self):
        ...
        with db.begin(write=True, buffers=True) as txn:
            for i, (pocket_fn, ligand_fn, _, rmsd_str) in enumerate(tqdm(index)):
                ...
                try:
                    pocket_dict = parse_PDB_v2(os.path.join(self.raw_path, pocket_fn))
...
if __name__ == '__main__':
    dataset = PocketLigandPairDataset('/home/aichengwei/home/wangyarong/ResGen-main/ResGen-main/crossdocked_pocket10')
